...
def split_cloud(cloud):
  ...
  filtered_cloud = do_passthrough_filter(point_cloud = downsampled_cloud, 
                                         name_axis = 'z', min_axis = -100, max_axis = 100)
...
def pcl_callback(pcl_msg):
  ...
  clusters = get_clusters(colorless_cloud, tolerance = 0.05, min_size = 20, max_size = 1500000)
...
if __name__ == '__main__':
  ...
  # Create Subscribers
  subscriber = rospy.Subscriber("/velodyne_obstacles", PointCloud2, pcl_callback, queue_size = 1)
