...
void PriusHybridPlugin::OnPriusCommand(const mirvehicle_msgs::Control::ConstPtr &msg)
{
  ...
  {
    case mirvehicle_msgs::Control::NEUTRAL:
      this->dataPtr->directionState = PriusHybridPluginPrivate::NEUTRAL;
      break;
    case mirvehicle_msgs::Control::FORWARD:
      this->dataPtr->directionState = PriusHybridPluginPrivate::FORWARD;
      break;
    case mirvehicle_msgs::Control::REVERSE:
